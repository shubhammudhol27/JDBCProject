var token = "90932955|-31949275022503535|90947787";
var dbName = "SCHOOL-DB";
var relName = "STDENT-TABLE";
...
function checkrecord() {
    ...
    jQuery.ajaxSetup({ async: false });
    var resultObj = executeCommandAtGivenBaseUrl(getReqStr, JDBCBaseUrl, JPDBirl);
    if (resultObj.status !==200) {
...
function RegisterStudent() {
    ...
    jQuery.ajaxSetup({ async: false });
    var resultObj = executeCommandAtGivenBaseUrl(putReqStr, JDBCBaseUrl,JPDBiml);
    if (resultObj.status === 200) {
